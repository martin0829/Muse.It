    ...
    static func getSongs(genre: String) -> [Song] {
        ...
        if genre == "Pop" {
            ...
            songs = [
                ...
                Song(title: "Brass Monkey", artist: "Beastie Boys", genre: "Pop", album: "album_cover1"),
                Song(title: "Straight Outta Compton", artist: "NWA", genre: "Pop", album: "brassmonkey_album"),
